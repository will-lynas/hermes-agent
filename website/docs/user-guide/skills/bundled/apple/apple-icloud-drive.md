---
title: "Icloud Drive — Operate cloud-backed files safely on macOS"
sidebar_label: "Icloud Drive"
...
Operate cloud-backed files safely on macOS.
...
| Path | `skills/apple/icloud-drive` |
| Version | `0.1.0` |
